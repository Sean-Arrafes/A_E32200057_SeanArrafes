        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-file-o"></i>Pendidikan</li>
            </ol>
          </div>
        </div>
        <!-- Form validation -->
              ...
              <div class="form">
                ...
                action="{{route('pendidikan.store')}}">
                  ...
                  <div class="form-group">
                    <label for="cname" class="control-label col-sm-2">Nama Sekolah <span
                            class="required">*</span></label>
                    <div class="col-sm-10">
                      <input class="form-control" id="nama" name="nama" minlenght="5" type="text" 
                          required />
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="curl" class="col-sm-2 control-label">Tahun Masuk<span 
                            class="required">*</span></label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group">
                    <label for="curl" class="control-label col-sm-2">Tahun Selesai <span 
                            class="required">*</span></label>
                    <div class="col-lg-10">
